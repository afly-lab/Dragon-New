  ...
  return (
    <section id="problem" className="py-24 md:py-32 lg:py-40 relative bg-cream-dark border-y border-ink/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {cards.map((card, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white border border-gray-100 p-8 rounded-sm hover:-translate-y-1 hover:shadow-xl hover:shadow-ink/5 transition-all duration-300 relative group overflow-hidden"
              >
        ...
        <div id="risk-simulator" className="bg-white rounded-2xl border border-gold/20 shadow-sm p-8 md:p-12 relative overflow-hidden shadow-2xl shadow-ink/5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="inline-flex items-center gap-2 bg-gold/10 px-3 py-1 rounded-sm mb-4">
                ...
                <span className="font-mono text-[9px] uppercase tracking-wider text-gold-dark font-semibold">
            ...
            <div className="lg:col-span-5 bg-white hover:bg-blue-50/30 border border-gold/20 p-8 rounded flex flex-col justify-between transition-all duration-300">
              <div className="space-y-6">
                <div>
