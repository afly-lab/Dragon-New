  ...
  return (
    <div className="relative min-h-screen bg-cream selection:bg-gold/30 selection:text-ink pb-0">
      ...
      <div className="photo-strip">
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=500&q=80" alt="Lab testing" loading="lazy" /><div className="photo-strip-label">Lab Testing</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&q=80" alt="Market research" loading="lazy" /><div className="photo-strip-label">Market Research</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1586528116493-a029325540f5?w=500&q=80" alt="Freight logistics" loading="lazy" /><div className="photo-strip-label">Freight Logistics</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=500&q=80" alt="Container shipping" loading="lazy" /><div className="photo-strip-label">Container Shipping</div></div>
      </div>

      {/* ── SERVICE PHOTO STRIP ── */}
      <div className="photo-strip border-t border-gray-100">
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=500&q=80" alt="Lab testing" loading="lazy" /><div className="photo-strip-label">Lab Testing</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&q=80" alt="Market research" loading="lazy" /><div className="photo-strip-label">Market Research</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1586528116493-a029325540f5?w=500&q=80" alt="Freight logistics" loading="lazy" /><div className="photo-strip-label">Freight Logistics</div></div>
        <div className="photo-strip-item"><img src="https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=500&q=80" alt="Container shipping" loading="lazy" /><div className="photo-strip-label">Container Shipping</div></div>
      ...
      {/* SOURCING PHOTO SPLIT before compare */}
      <div className="split-section border-t border-ink/10">
        <div className="split-img-col" style={{minHeight:"340px"}}>
          <img src="https://images.unsplash.com/photo-1605745341112-85968b19335b?w=900&q=80" alt="China factory floor" loading="lazy" />
          <div className="split-img-badge">On-Ground<br/>Physical Presence</div>
        </div>
        <div className="flex flex-col justify-center p-12 bg-ink text-cream">
          <span className="font-mono text-xs uppercase tracking-widest text-gold font-semibold mb-3 block">Why It Matters</span>
          <h3 className="font-serif text-3xl text-cream leading-tight mb-4">
            Your suppliers treat local<br/><span className="italic font-light text-cream/50">representatives differently.</span>
          </h3>
          <p className="text-cream/60 text-sm leading-relaxed">Factories prioritise production timelines for buyers who can physically show up. Our WFOE registration gives us the same standing as a local Chinese company — and the legal teeth to enforce it.</p>
        </div>
      </div>

      {/* ── STATS BAND (Dragon Sourcing style dark navy bar) ── */}
      <div className="stats-band">
        {[
          {icon:"😊", num:"2000+", label:"Happy Clients"},
          {icon:"📋", num:"5000+", label:"Projects Completed"},
          {icon:"🏭", num:"1000+", label:"Factories Verified"},
          {icon:"🏆", num:"10+",   label:"Years Experience"},
          {icon:"🌐", num:"50+",   label:"Countries Served"},
          {icon:"👥", num:"6",     label:"Export Markets"},
        ].map((s,i) => (
      ...
      {/* ── SOURCING PHOTO SPLIT before comparison ── */}
      <div className="split-section border-t border-gray-100">
        <div className="split-img-col" style={{minHeight:"320px"}}>
          <img src="https://images.unsplash.com/photo-1605745341112-85968b19335b?w=900&q=80" alt="China factory floor" loading="lazy" />
          <div className="split-img-badge">On-Ground<br/>Physical Presence</div>
        </div>
        <div className="flex flex-col justify-center p-12 bg-ink text-white">
          <span className="font-sans text-sm font-bold text-gold uppercase tracking-widest mb-3 block">Why It Matters</span>
          <h3 className="font-sans font-bold text-3xl text-white leading-tight mb-4">
            Your suppliers treat local<br/><span className="font-light text-white/50">representatives differently.</span>
          </h3>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-cream border border-ink/15 hover:border-gold/60 p-8 rounded-sm flex flex-col justify-between hover:shadow-xl hover:shadow-ink/5 transition-all duration-300 relative">
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-dark font-bold">Up to 3 Active Products</span>
                ...
                <div className="border-t border-ink/10 pt-6">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-dark font-semibold block mb-3">Everything included</span>
            ...
            <div className="bg-cream border border-gold hover:border-gold-dark p-8 rounded-sm flex flex-col justify-between hover:shadow-xl hover:shadow-gold/5 transition-all duration-300 relative shadow-md shadow-gold/[0.02]">
              ...
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-dark font-bold block mt-1">Up to 8 Active Products</span>
                ...
                <div className="border-t border-ink/10 pt-6">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-dark font-semibold block mb-3">Everything in Starter, plus more volume</span>
                  <ul className="space-y-3 font-mono text-[11px] uppercase tracking-wider text-ink-light">
                    {[
            ...
            <div className="bg-ink border-2 border-gold p-8 rounded-sm flex flex-col justify-between shadow-2xl shadow-ink/15 relative lg:-translate-y-2">
              ...
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-light font-bold block mt-1">Unlimited Active Products</span>
                ...
                <div className="border-t border-cream/15 pt-6">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-light font-semibold block mb-3">Everything in Growth, plus</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-cream border border-ink/15 hover:border-gold/60 p-7 rounded-sm flex flex-col justify-between hover:shadow-xl hover:shadow-ink/5 transition-all duration-300">
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-dark font-bold block mb-3">1 Service · within 48 hours</span>
                ...
                <div className="border-t border-ink/10 pt-4">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-dark font-semibold block mb-2">Includes 1 service</span>
            ...
            <div className="bg-cream border border-ink/15 hover:border-gold/60 p-7 rounded-sm flex flex-col justify-between hover:shadow-xl hover:shadow-ink/5 transition-all duration-300">
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-dark font-bold block mb-3">2 Services · within 72 hours</span>
                ...
                <div className="border-t border-ink/10 pt-4">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-dark font-semibold block mb-2">Includes 2 services</span>
                  <ul className="space-y-2.5 font-mono text-[10px] uppercase tracking-wider text-ink-light">
                    <li className="flex items-start gap-2"><span className="text-gold font-bold shrink-0">①</span><span>On-the-ground supplier verification</span></li>
            ...
            <div className="bg-cream border border-gold hover:border-gold-dark p-7 rounded-sm flex flex-col justify-between hover:shadow-xl hover:shadow-gold/5 transition-all duration-300 relative shadow-md shadow-gold/[0.02]">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gold text-ink text-[8px] font-mono font-bold uppercase tracking-[0.14em] py-1 px-4 rounded-sm shadow-sm whitespace-nowrap">
                Most Popular
              </span>
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-dark font-bold block mb-3 mt-1">3 Services · within 72 hours</span>
                ...
                <div className="border-t border-ink/10 pt-4">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-dark font-semibold block mb-2">Includes 3 services</span>
                  <ul className="space-y-2.5 font-mono text-[10px] uppercase tracking-wider text-ink-light">
                    <li className="flex items-start gap-2"><span className="text-gold font-bold shrink-0">①</span><span>On-the-ground supplier verification</span></li>
                    <li className="flex items-start gap-2"><span className="text-gold font-bold shrink-0">②</span><span>Single-product sourcing report</span></li>
              ...
              <div className="mt-8">
                <a href="#contact" onClick={() => setInquireForm(prev => ({ ...prev, plan: "On-Demand: 3 Services — Verify + Source + Inspect — $179" }))}
                  className="w-full text-center bg-ink text-cream hover:bg-gold hover:text-ink font-mono text-[10px] uppercase tracking-widest font-bold py-3 px-4 rounded-sm transition-all duration-300 block">
                  Request This →
                </a>
              </div>
            </div>
            ...
            <div className="bg-ink border-2 border-gold p-7 rounded-sm flex flex-col justify-between shadow-2xl shadow-ink/15 relative">
              ...
              <div>
                <span className="font-mono text-[9px] uppercase tracking-widest text-gold-light font-bold block mb-3 mt-1">4 Services · end-to-end</span>
                ...
                <div className="border-t border-cream/15 pt-4">
                  <span className="font-mono text-[8px] uppercase tracking-wider text-gold-light font-semibold block mb-2">Includes 4 services</span>
              ...
              <div className="mt-8">
                <a href="#contact" onClick={() => setInquireForm(prev => ({ ...prev, plan: "On-Demand: 4 Services — Full On-Ground Package — $299" }))}
                  className="w-full text-center bg-gold hover:bg-cream text-ink font-mono text-[10px] uppercase tracking-widest font-bold py-3 px-4 rounded-sm transition-all duration-300 block">
                  Request This →
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-4 flex justify-center w-full">
              <div className="md-photo-frame relative w-48 aspect-[3/4] shadow-xl shadow-ink/5 overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-t from-ink/80 via-ink/10 to-transparent z-10"></div>
                <img
...
I founded XinAo to be the operation I never found as an exporter — flat fee, zero commission, physically present, working only for the buyer."
      ...
      {/* ── CTA DARK BAND ── */}
      <div className="cta-dark-band py-16">
        <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="font-sans font-extrabold text-2xl md:text-3xl text-white leading-tight">Ready to Simplify Your Sourcing in China?</h2>
            <p className="text-white/55 text-sm mt-2">Let our local experts handle the complexities while you focus on growth.</p>
          </div>
          <div className="flex gap-3 flex-wrap flex-shrink-0">
            <a href="#audit-planner" className="bg-gold hover:bg-gold-dark text-white font-sans font-bold text-sm py-3 px-6 rounded-lg transition-all shadow-lg">Get A Free Quote</a>
            <a href="#contact" className="border-2 border-white/30 hover:border-white text-white font-sans font-bold text-sm py-3 px-6 rounded-lg transition-all">Talk To An Expert</a>
          </div>
        </div>
      </div>
      ...
      {/* FOOTER */}
      <footer className="bg-ink text-white border-t border-white/8 pt-24 pb-12 select-none">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
